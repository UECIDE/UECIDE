...
public class JFontChooser extends JComponent
{
    ...
    private boolean monoSpaceOnly = false;

	/**
	 * Constructs a <code>JFontChooser</code> object.
	 **/
	public JFontChooser(boolean mono)
	{
		constructInterface(DEFAULT_FONT_SIZE_STRINGS, mono);
	}

	public JFontChooser()
	{
		constructInterface(DEFAULT_FONT_SIZE_STRINGS, false);
	}
	...
	{
        constructInterface(fontSizeStrings, false);
    }

    public void constructInterface(String[] fss, boolean monoOnly)
    {
        fontSizeStrings = fss;
		...
		if (fontFamilyNames == null)
		{
            ...
            if (monoSpaceOnly == false) {
                ...
                for (Font f : fonts) {
                    ...
                    int iw = fm.charWidth('i');
                    int mw = fm.charWidth('m');
                    if (iw == mw) {
                        names.add(f.getName());
                    }
                }
                fontFamilyNames = names.toArray(new String[names.size()]);
            }
		}
